...
describe('ExcludedFolders', () => {
  ...
  it('debounces onChangeExcludedFolders and emits last value only once', async () => {
    ...
    render(
      <ExcludedFolders excludedFolders={'a'} onChangeExcludedFolders={onChange} />,
    )
  ...
  it('syncs local state with prop changes', () => {
    ...
    const { rerender } = render(
      <ExcludedFolders excludedFolders={'foo'} onChangeExcludedFolders={onChange} />,
    )

    // Change prop -> component should reflect it
    rerender(
      <ExcludedFolders excludedFolders={'baz'} onChangeExcludedFolders={onChange} />,
    )
  ...
  it('associates label with textarea via htmlFor/id', () => {
    const onChange = vi.fn()
    render(
      <ExcludedFolders excludedFolders={'x'} onChangeExcludedFolders={onChange} />,
    )
